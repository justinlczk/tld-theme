...
if (imagesSliderHero.length > 1) {
  ...
  dotsSliderHero.forEach((item, index) => {
    item.addEventListener("click", () => {
      ...
      let oldItem = arrayItems.find((item2) => item2.activated === true);
    ...
    sliderProjectPage,
    {
      ...
      pagination: {
        ...
        renderFraction: function(currentClass, totalClass) {
          return '<span class="' + currentClass + '"></span> <span class="separator-fraction"></span> <span class="' + totalClass + '"></span>';
        }
      },
      navigation: {
        nextEl: ".swiper-button-next",
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  if (sliderProjectsHome) {
    ...
    const process = () => {
      ...
      (_a = allSlides.toArray().find((slide2) => slide2.classList.contains("swiper-slide-prev-prev"))) == null ? void 0 : _a.classList.remove("swiper-slide-prev-prev");
      (_b = allSlides.toArray().find((slide2) => slide2.classList.contains("swiper-slide-prev-next"))) == null ? void 0 : _b.classList.remove("swiper-slide-prev-next");
