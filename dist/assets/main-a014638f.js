  ...
  if (slidersProjectsHome) {
    ...
    slidersProjectsHome.forEach((sliderProjectsHome) => {
      ...
      swiperSliderProjectsHome.on("slideChange", function() {
        ...
        (_a = sliderProjectsHome.querySelector(".swiper-slide-prev-prev")) == null ? void 0 : _a.classList.remove("swiper-slide-prev-prev");
        (_b = sliderProjectsHome.querySelector(".swiper-slide-next-next")) == null ? void 0 : _b.classList.remove("swiper-slide-next-next");
